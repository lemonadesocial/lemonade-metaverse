...
export type TokensOfQuery = { __typename?: 'Query', tokens: Array<{ __typename?: 'Token', id: string, contract: string, createdAt?: Maybe<string>, creator?: Maybe<string>, tokenId: string, uri: string }> };
